...
Demonstrates:
  ...
  3) We measure Time-To-First-Token (TTFT) from the moment we invoke `generate_async(streaming=True)`
...
def main():
    ...
    start_t = time.time()
    try:
        stream_iter_1 = engine1.generate_async(
            inputs=turn1_ids,
        ...
        # Optionally consume the rest of the stream
        # for token in stream_iter_1:
        #     pass
    except Exception as e:
        print(f"[ERROR] ENGINE1 Turn 1 failed: {e}")
        ttft_engine1_turn1 = None
    ...
    start_t2 = time.time()
    try:
        stream_iter_2 = engine1.generate_async(
            inputs=turn2_ids,
            kv_cache_retention_config=retention1,
            streaming=True  # Enable streaming mode
        )
        ...
        print(f"[ERROR] ENGINE1 Turn 2 failed: {e}")
        ttft_engine1_turn2 = None
    ...
    try:
        stream_iter_1_e2 = engine2.generate_async(
            inputs=turn1_ids_e2,
        ...
        print(f"[ERROR] ENGINE2 Turn 1 failed: {e}")
        ttft_engine2_turn1 = None
    ...
    try:
        stream_iter_2_e2 = engine2.generate_async(
            inputs=turn2_ids_e2,
            kv_cache_retention_config=retention2,
            streaming=True  # Enable streaming mode
        )
        ...
        print(f"[ERROR] ENGINE2 Turn 2 failed: {e}")
        ttft_engine2_turn2 = None
