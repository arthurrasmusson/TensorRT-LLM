...
std::unique_ptr<DecoderTestShared<TLogits>> SetupDecoderTest(TrivialConstantDecoderTestParameters const& params)
{
    ...
    auto const executorConfig
        = executor::ExecutorConfig(params.maxBeamWidth, executor::SchedulerConfig(), executor::KvCacheConfig{}, true,
...
template <typename TLogits>
class DecoderTopKGenerationLogitsTest : public ::testing::Test,
                                        public ::testing::WithParamInterface<TrivialConstantDecoderTestParameters>
{
protected:
    ...
    void runTopKGenerationLogitsTest(TrivialConstantDecoderTestParameters const& parameters)
    {
...
protected:
    ...
    void runTopKGenerationLogitsStreamingTest(TrivialConstantDecoderTestParameters const& parameters)
    {
        auto const requestTokens = createConsecutiveTokenSequence(parameters.promptLength, parameters.vocabSize);
        auto requests = std::vector<executor::Request>{};
        requests.reserve(static_cast<std::size_t>(parameters.numRequests));
...
template <typename TLogits>
class DecoderTopKContextLogitsStreamingTest : public ::testing::Test,
                                              public ::testing::WithParamInterface<TrivialConstantDecoderTestParameters>
{
protected:
    std::unique_ptr<DecoderTestShared<TLogits>> state;
    ...
    void runTopKContextLogitsTest(TrivialConstantDecoderTestParameters const& parameters)
    {
        auto const requestTokens = createConsecutiveTokenSequence(parameters.promptLength, parameters.vocabSize);
        auto requests = std::vector<executor::Request>{};
        requests.reserve(static_cast<std::size_t>(parameters.numRequests));
...
template <typename TLogits>
class DecoderTopKContextLogitsTest : public ::testing::Test,
                                     public ::testing::WithParamInterface<TrivialConstantDecoderTestParameters>
{
protected:
    std::unique_ptr<DecoderTestShared<TLogits>> state;
...
auto const paramGenerator = ::testing::ConvertGenerator<TrivialConstantDecoderTestParameters::TupleT>(
...
INSTANTIATE_TEST_SUITE_P(Float, DecoderTopKGenerationLogitsFloatTest, paramGenerator);
...
INSTANTIATE_TEST_SUITE_P(Float, DecoderTopKGenerationLogitsStreamingFloatTest, paramGenerator);
...
INSTANTIATE_TEST_SUITE_P(Float, DecoderTopKContextLogitsStreamingFloatTest, paramGenerator);
...
INSTANTIATE_TEST_SUITE_P(Float, DecoderTopKContextLogitsFloatTest, paramGenerator);
