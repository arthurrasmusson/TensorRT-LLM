...
@click.command()
def main():
    # Paths to your two engine directories (405B model)
    engine1_path = "/mnt/weka/Models/Engines/Meta-Llama-3.1-405B-Instruct-AWQ-INT4-FMHA-ON"
    engine2_path = "/mnt/weka/Models/Engines/Meta-Llama-3.1-405B-Instruct-AWQ-INT4-FMHA-OFF"
    
    # Path to the 405B tokenizer
    tokenizer_path = "/mnt/weka/Models/Safetensors/Meta-Llama-3.1-405B-Instruct"

    # Common build config for both engines (set max_seq_len=120k to match build)
    build_config = BuildConfig(
        max_beam_width=1,
        max_batch_size=1,        # Usually keep batch=1 with 405B + 120k context
        max_num_tokens=2048,
        max_seq_len=120000
    )
    ...
    def create_llm(engine_path, tokenizer_path, policy, block_reuse, tp_size=8, pp_size=1):
        kv_cache_config = KvCacheConfig(
            ...
            host_cache_size=45_000_000_000,  # e.g. 45 GiB for demonstration
            max_tokens=8000,                 # Max tokens in the prompt or decode per request
    ...
    # For engine1, we keep retention config for demonstration
    ...
    # For engine2, we disable block reuse / KV
    retention2 = None

    # Read an existing large text
    ...
    print("\n====================================================")
    print("Running ENGINE1-FMHA-ON (Paged KV + block reuse ON)")
    print("====================================================\n")
    ...
    print(
        f"[ENGINE1-FMHA-ON] Stats-based TTFT_ms={parse_res_1['TTFT_ms']}, "
    ...
    print("\n====================================================")
    print("Running ENGINE2-FMHA-OFF (KV cache disabled)")
    print("====================================================\n")
    ...
    print(
        f"[ENGINE2-FMHA-OFF] Stats-based TTFT_ms={parse_res_2['TTFT_ms']}, "
